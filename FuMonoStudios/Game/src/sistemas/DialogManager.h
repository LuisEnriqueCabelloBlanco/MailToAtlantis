...
public:
    ...
    void setDialogues(std::string& dialogo, std::string character = ""); //no se pasa por const porque la modificamos con el fixText, no te preocupes cleon
    ...
    static void fixText(std::string& text);
